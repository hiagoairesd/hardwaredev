...
//==============================================================================
    ...
    wire D_take_branch, D_halt, D_EN, D_CLR;
...
//==============================================================================
    ...
    assign D_branchOperandA =  D_forwardA? M_aluOut : D_rf_out1;
    assign D_branchOperandB =  D_forwardB? M_aluOut : D_rf_out2;
    //---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    assign D_PCbranch = D_PCplus4 + D_imm_ext;
    ...
    assign D_take_branch = (D_is_beq && (D_branchOperandA == D_branchOperandB)) |
                           (D_is_bne && (D_branchOperandA != D_branchOperandB)) |
                           (D_is_blt && (D_branchOperandA <  D_branchOperandB));
