...
// 1) Local parameters
//==============================================================================
    localparam OP_BEQ = 6'b000100, OP_BNE = 6'b000101, OP_BLT = 6'b000110;
...
//==============================================================================
    ...
    wire       D_jump, D_is_shift, D_imm_is_zext, D_is_beq, D_is_bne, D_is_blt;
...
//==============================================================================
    ...
    assign D_is_bne  = (D_opcode == OP_BNE);
    assign D_is_blt  = (D_opcode == OP_BLT);
    assign D_is_beq  = (D_opcode == OP_BEQ);
    ...
    assign D_take_branch = (D_is_beq && (D_rf_out1 == D_rf_out2)) |
                           (D_is_bne && (D_rf_out1 != D_rf_out2)) |
                           (D_is_blt && (D_rf_out1 < D_rf_out2));
    //---------------------------------------------------------
    // MEMORY STAGE
    //---------------------------------------------------------
    // M register
