module control_unit_tb();
    ...
    task check_extended;
        ...
        begin
            ...
            if(is_beq !== (DUT.opcode == 6'b000100)) begin
                $display("TEST FAILED - is_beq Mismatch");
                $display("At time %0d: is_beq = %b, expected %b", 
                            $time, is_beq, (DUT.opcode == 6'b000100));
                $finish;
            end

            if(is_bne !== (DUT.opcode == 6'b000101)) begin
                $display("TEST FAILED - is_bne Mismatch");
                $display("At time %0d: is_bne = %b, expected %b", 
                            $time, is_bne, (DUT.opcode == 6'b000101));
                $finish;
            end

            if(is_blt !== (DUT.opcode == 6'b000110)) begin
                $display("TEST FAILED - is_blt Mismatch");
                $display("At time %0d: is_blt = %b, expected %b", 
                            $time, is_blt, (DUT.opcode == 6'b000110));
                $finish;
            end
            
            $display("At time %0d: word=%b | is_shift=%b | imm_is_zext=%b | is_beq=%b | is_bne=%b | is_blt=%b | halt=%b OK",
                        $time, DUT.word, is_shift, imm_is_zext, is_beq, is_bne, is_blt, halt);
        end
    endtask
    ...
    initial begin
        ...
        #5 check_extended(9'b110011000, 1'b1, 1'b0, 1'b0);
        
        $display("\t\t\tSRL (is_shift=1)");
        instr = 32'b00000001010010110100000000000010; 
        #5 check_extended(9'b110100000, 1'b1, 1'b0, 1'b0);
        ...
        #5 check_extended(9'b101010010, 1'b0, 1'b0, 1'b0);
        
        $display("\t\t\tSW (store)");
        instr = 32'b10101111101010110000000000000000; 
        #5 check_extended(9'b001010100, 1'b0, 1'b0, 1'b0);
        ...
        #5 check_extended(9'b000110000, 1'b0, 1'b0, 1'b0);
        ...
        #5 check_extended(9'b000000001, 1'b0, 1'b0, 1'b0);
        ...
        #5 check_extended(9'b000000000, 1'b0, 1'b0, 1'b1);
        ...
        #5 check_extended(9'b000000000, 1'b0, 1'b0, 1'b0);
